...
public class ExampleMain4 {
	...
	public static void main(String[] args) {
		AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(ExampleMain4.class);
		...
		DefaultMessageCodesResolver messageCodesResolver = (DefaultMessageCodesResolver) bindingResult
		...
		bindingResult.getAllErrors().forEach(e -> System.out.println(context.getMessage(e, new Locale("in", "id"))));
	}
}